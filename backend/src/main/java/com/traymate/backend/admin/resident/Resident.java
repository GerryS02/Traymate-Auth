...
public class Resident {
    ...
    // app can hydrate SettingsContext directly off this column. Also
    // fed into the Gemini system prompt so GrannyBT replies in the
    // resident's chosen language without the frontend re-picking it
    // each session.
